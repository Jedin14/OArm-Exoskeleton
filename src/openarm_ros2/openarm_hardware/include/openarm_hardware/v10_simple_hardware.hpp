...
//   const std::vector<double> DEFAULT_KP = {2.0, 2.0, 2.0, 2.0,
//       1.0,  1.0,  1.0,  0.5};
//   const std::vector<double> DEFAULT_KD = {2.75, 2.5, 0.7, 0.4,
//       0.7,  0.6, 0.5, 0.1};
 

  // x2 of kp and kd，kp越大，相当于弹簧刚性越大，响应越快，kd越大，阻尼越大
  const std::vector<double> DEFAULT_KP = {100.0, 100.0, 100.0, 100.0,
                                          10.0, 10.0, 10.0, 0.5};
  const std::vector<double> DEFAULT_KD = {5.5, 5.0, 1.4, 0.8,
                                          1.4, 1.2, 1.0, 0.2};
  ...
  const double GRIPPER_DEFAULT_KP = 25.0;
