...
int main(int argc, char **argv) {
    try {
        ...
        YamlLoader leader_loader("/home/ok/openarmx_ws/src/openarm_teleop/config/leader.yaml");
        YamlLoader follower_loader("/home/ok/openarmx_ws/src/openarm_teleop/config/follower.yaml");
